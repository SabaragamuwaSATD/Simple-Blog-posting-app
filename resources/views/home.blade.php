...
<body>
    @auth
        <div style="text-align: center; margin-bottom: 20px;">
            ...
            <form action="/create-post" method="GET" style="display: inline-block;">
                <button type="submit" style="padding: 10px 20px; background-color: #28a745; color: white; border: none; border-radius: 5px; cursor: pointer;">Create Post</button>
            </form>
        </div>
